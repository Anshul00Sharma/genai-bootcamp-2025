...
- The backend will be built using TypeScript and bun
- The database will be PostgreSQL
- for type safety, we will be using tRPC
...
Our database will be a single PostgreSQL database called `words.db` that will be in the root of the project folder of `Backend`.
